...
**Survival game** hvor spilleren undg�r en papirklips s� l�nge som muligt. Enkelt koncept med stigende sv�rhedsgrad og strategiske power-ups.
...
### M�l
Overlev s� l�nge som muligt uden at blive ramt af den jagtende papirklips!

### Controls
- ** Desktop**: Flyt musen for at bev�ge dig rundt
- ** Mobile**: Tryk p� sk�rmen for at teleportere til touchpunktet

### Items
- ** Gr�nne items**: S�nker papirklipsens hastighed midlertidigt
- ** R�de items**: �ger papirklipsens hastighed (undg� dem!)
- Items spawner tilf�ldigt og forsvinder efter kort tid

### Sv�rhedsgrad
Spillet bliver gradvist sv�rere:
- **0-30s**: Speed 1.0x
- **30-60s**: Speed 1.5x  
- **60-90s**: Speed 2.0x
- **90-120s**: Speed 2.5x
...
Spillet k�rer p�: **http://localhost:8082**
...
```json
{
  "success": true,
  "rank": 5,
  "message": "Godt klaret! Du er nr. 5 p� leaderboardet! "
}
```
...
Se .env.example for p�kr�vede variabler:
```env
PGHOST=localhost
PGPORT=5432
PGDATABASE=appdb
...
- Progressive sv�rhedsgrad
- Power-up system (gr�nne/r�de items)
...
- Sessions udl�ber efter 10 minutter
- Start nyt spil for at f� ny token
